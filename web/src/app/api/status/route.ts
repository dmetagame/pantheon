...
export async function GET(req: Request) {
  ...
  return NextResponse.json(
    ...
    totals: {
      ...
      legacyBlocked: stats.totalLegacyBlocked,
    ...
    gods: gods.map((g) => ({
      ...
      chainReputationBp: g.chainReputationBp,
      reputationVerified: g.reputationVerified,
      prophecies_settled: g.prophecies_settled,
      prophecies_pending: g.prophecies_pending,
      prophecies_legacy_blocked: g.prophecies_legacy_blocked,
